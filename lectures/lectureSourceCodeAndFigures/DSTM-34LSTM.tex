...
\end{itemize}
\end{itemize}
\includegraphics[width=0.8\textwidth]{LSTM/LSTM3-SimpleRNN.png}
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\includegraphics[width=0.8\textwidth]{LSTM/LSTMNew.png}
\footnote{Reprinted with permission. \url{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{LSTM/highway.png}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{LSTM/memorized.png}
\footnote{Reprinted with permission.\\ \hspace{1.7em}\url{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{LSTM/dampen.png}
\footnote{Reprinted with permission.\\ \hspace{1.7em}\url{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{LSTM/adding.png}
\footnote{Reprinted with permission.\\ \hspace{1.7em}\url{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=1\textwidth]{LSTM/output.png}
\footnote{Reprinted with permission.\\ \hspace{1.7em}\url{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=0.9\textwidth]{LSTM/Stacked.jpg}
\end{frame}
%***********************************************************
